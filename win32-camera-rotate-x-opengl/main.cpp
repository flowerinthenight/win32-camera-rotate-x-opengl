...
#include "..\libcore\libcamera.h"

#pragma comment(lib, "opengl32.lib")
#pragma comment(lib, "glew32.lib")

#if _DEBUG
#pragma comment(lib, "../debug/libcore.lib")
#endif
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WIN32CAMERAROTATEXOPENGL));
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_WIN32CAMERAROTATEXOPENGL, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WIN32CAMERAROTATEXOPENGL));
